...
import type { AuditLog, CatalogSummary, DashboardOverview, Merchant, Product } from "../types";
...
export const getOverview = () => api<DashboardOverview>("/dashboard/overview");
export const getAuditLogs = () => api<AuditLog[]>("/audit-logs");
