import { BarChart3, BookOpenCheck, Boxes, BrainCircuit, CreditCard, LayoutDashboard, Moon, Search, Sparkles, Sun } from "lucide-react";
import type { Merchant } from "../../types";

type Props = { merchant: Merchant; activePage: "dashboard" | "catalog" | "recommendations" | "decision" | "campaigns" | "shopping" | "payments" | "audit"; onNavigate: (page: "dashboard" | "catalog" | "recommendations" | "decision" | "campaigns" | "shopping" | "payments" | "audit") => void; onLogout: () => void; theme: "dark" | "light"; onThemeToggle: () => void; children: React.ReactNode };
  ...
  return <div className={`min-h-screen bg-slate-950 text-slate-100 ${theme === "light" ? "theme-light" : ""}`}>
    <aside className="fixed inset-y-0 left-0 hidden w-64 border-r border-white/10 bg-slate-950 p-5 lg:block">
      ...
      <nav className="space-y-2">
        ...
        <Nav icon={<BrainCircuit size={18} />} label="AI Decision Center" active={activePage === "decision"} onClick={() => onNavigate("decision")} />
