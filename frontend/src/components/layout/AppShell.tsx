...
type Props = { merchant: Merchant; activePage: "dashboard" | "catalog"; onNavigate: (page: "dashboard" | "catalog") => void; onLogout: () => void; theme: "dark" | "light"; onThemeToggle: () => void; children: React.ReactNode };
