import { BarChart3, BookOpenCheck, Boxes, LayoutDashboard, Sparkles } from "lucide-react";
import type { Merchant } from "../../types";

type Props = { merchant: Merchant; activePage: "dashboard" | "catalog"; onNavigate: (page: "dashboard" | "catalog") => void; onLogout: () => void; children: React.ReactNode };

export function AppShell({ merchant, activePage, onNavigate, onLogout, children }: Props) {
